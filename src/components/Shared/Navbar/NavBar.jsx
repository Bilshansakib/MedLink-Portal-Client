...
const NavBar = () => {
  ...
  return (
    <nav className=" z-10 max-w-screen-xl mx-auto   bg-opacity-30  bg-blue-100 shadow dark:bg-gray-800">
      <div className="px-6 py-4  relative ">
        <div className="lg:flex  lg:items-center lg:justify-between">
          ...
          <div
            ...
            className={`absolute ${
              open ? "hidden" : ""
            } bg-blue-100 inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out  dark:bg-gray-800 lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center`}
          >
                ...
                <>
                  ...
                  <div className="dropdown dropdown-end hidden lg:block ">
                    ...
                    <ul
                      ...
                      className="sm:ml-10 absolute menu  menu-sm dropdown-content z-10 flex min-w-[180px] flex-col gap-2 overflow-auto rounded-md border border-blue-gray-50 bg-white p-3 font-sans text-sm font-normal text-blue-gray-500 shadow-lg shadow-blue-gray-500/10 focus:outline-none"
                    >
                      <button
                        role="menuitem"
